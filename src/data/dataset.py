...
INTENT_KEYWORDS_FR = {
    ...
    # "avoir\w*" retiré (B.6, docs/archive/audits/AUDIT_SAE_2026-08.md) : matchait le verbe "avoir",
    ...
    # docs/archive/audits/AUDIT_SAE_2026-08.md §8) : vérifié sur le corpus réel
