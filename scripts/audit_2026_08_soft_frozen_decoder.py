...
NEW_MODEL_NAME = f"audit_2026_08_soft_frozen_decoder_d{D_EXTRA}_k{K_EXTRA}"
...
OUT_PATH = os.path.join(SAVE_DIR, "cache", "audit_2026_08_soft_frozen_decoder_results.json")
...
def main():
    ...
    model.calibrate_scale(domain_residuals_cpu)
    print(f"[soft-frozen] input_scale calibré = {model.input_scale.item():.4f}, "
    ...
    print("\n" + "=" * 70)
    print(" RÉSUMÉ — SOFT-FROZEN DECODER (Korznikov et al.), cos>=0.8, échelle calibrée")
    print("=" * 70)
