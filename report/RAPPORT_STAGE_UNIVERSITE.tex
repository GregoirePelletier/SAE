...
\begin{tabular}{@{}lcc@{}}
\toprule
\textbf{Sélection} & \textbf{Juge gemma-3-12b-it} & \textbf{Juge Qwen3.8-27B} \\ \midrule
Stratifiée & 82,0\% (123/150) & \textbf{84,7\% (127/150) --- référence (R0)} \\
Magnitude & \emph{en cours} (M1) & --- \\
\bottomrule
\end{tabular}
\end{table}

À sélection stratifiée fixée, le choix du juge ne produit \textbf{aucun écart
significatif} à cette configuration (82,0\%~$\to$~84,7\%, $z=-0{,}62$,
