...
Le réservoir de résidus utilisé pour l'entraînement de l'extension est
memory-mapped sur disque plutôt qu'alloué en RAM proportionnellement au
volume de tokens visé, ce qui rend schedulable un run au seuil de
convergence de 100-200 millions de tokens revendiqué par SAE Boost --- non
